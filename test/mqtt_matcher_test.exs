defmodule MQTTMatcherTest do
  ...
  test "rest" do
  	assert SampleMatcher.mqtt_match("rest/super/a/w/e/s/o/m/e") == {:rest, ["super", "a", "w", "e", "s", "o", "m", "e"]}
  end

  test "full rest" do
  	assert SampleMatcher.mqtt_match("fullrest/1/2/3/4/5") == {:full_rest, ["fullrest", "1", "2", "3", "4", "5"]}
  end
end
